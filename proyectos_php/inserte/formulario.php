...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            <div class="login">
                <?php
                //la funcion error_reporting eliminaremos los reportes de error
            ...
            <div class="formulario">
                <form name="registro" method="post" action="registro.php">
                    ...
                    <div class="botones">
                        ...
                        <?php
                        //Estos mensajes son los que entregara el programa dependiendo del resultado de la validaion de las contraseñas
                        if($_GET["errornea"] =="si"){
